 ...
 * <p/>
 * Loading of DbUnit data sets can be done by annotating a class or method with the {@link org.unitils.dbunit.annotation.DataSet} annotation. The name
 ...
 * <p/>
 * By annotating a method with the {@link org.unitils.dbunit.annotation.ExpectedDataSet} annotation or by calling the {@link #assertDbContentAsExpected}
...
public class DbUnitModule implements Module {
     ...
     * {@link org.unitils.dbunit.annotation.DataSet} annotation. If specified using this annotation but not found, a {@link org.unitils.core.UnitilsException} is
     * thrown.
     *
     ...
     * using the default {@link org.unitils.dbunit.datasetloadstrategy.DataSetLoadStrategy} and {@link org.unitils.dbunit.datasetfactory.DataSetFactory} class.
     *
    ...
    /**
     * Using the values of the method-level or class-level {@link org.unitils.dbunit.annotation.DataSet} annotations, returns the data set for the
     * given test method. If no method-level or class-level {@link org.unitils.dbunit.annotation.DataSet} annotation is found, null is returned.
     * If a method-level {@link org.unitils.dbunit.annotation.DataSet} annotation is found this will be used, else the class-level will be used.
     * <p/>
     ...
     * @param testMethod The test method, not null
     * @param testObject The test object, not null
     * @return The dataset, null if no {@link org.unitils.dbunit.annotation.DataSet} annotation is found.
     */
    ...
    /**
     * Returns the {@link org.unitils.dbunit.util.MultiSchemaDataSet} that represents the state of a number of database tables after the given
    ...
    protected DbUnitDatabaseConnection createDbUnitConnection(String schemaName) {
        ...
        if (dbSupport.getDatabaseDialect().toLowerCase().equals("mysql")) {
    ...
    /**
     * @return The default {@link org.unitils.dbunit.datasetfactory.DataSetFactory} class as configured in unitils
     */
    @SuppressWarnings("unchecked")
     ...
     * @return The {@link org.unitils.dbunit.datasetfactory.DataSetFactory} with the given class
     */
    ...
    /**
     * @return The default {@link org.unitils.dbunit.datasetloadstrategy.DataSetLoadStrategy} class as configured in unitils
     */
    @SuppressWarnings("unchecked")
