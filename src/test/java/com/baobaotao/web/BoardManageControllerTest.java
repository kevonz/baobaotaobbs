...
public class BoardManageControllerTest extends BaseWebTest {
    ...
    public void addTopic() throws Exception {
        ...
        ModelAndView mav = handlerAdapter.handle(request, response, controller);
        assertThat(mav.getViewName(), is("redirect:/board/listBoardTopics-1.html"));
    }
...
//        Page pagedPost = (Page) request.getAttribute("pagedPost");
        Topic topic = (Topic) mav.getModel().get("topic");
        Page pagedPost = (Page) mav.getModel().get("pagedPost");
